...
### SC Destructive operations through PaaS CLI tools
- category: cloud
...
### SC Migration tools that reset or roll back a real database
- category: database
- decision: approval_required | severity: 4
...
### SC Write-grade SQL when the connection points at production
- category: database
...
### SC kubectl exec, cp and port-forward against production workloads
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
...
### SC First contact: mutating verbs against a non-local cluster with no production in the name
- category: cloud
- decision: approval_required | severity: 4
...
### SC Terraform destroy by other name: replace, taint, and state tampering
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
- sources: cloud-kiro-delete-and-recreate
...
### SC Production deployments from agent ancestry
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
...
### SC Edits to CI pipeline files from agent ancestry
- category: cloud
- decision: approval_required | severity: 4
...
### SC gh CLI operations on CI secrets and workflow runs
- category: secrets
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
...
### SC Cloud credential minting and role escalation from the agent process tree
- category: cloud
- decision: approval_required | severity: 4
- pack: cross | coverage: gap
...
### SC Destructive mutations sent by generic HTTP clients to cloud control planes
- category: network
- decision: approval_required | severity: 5
...
### SC DNS and domain record changes from agent ancestry
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
- sources: cloud-pocketos-railway-volume-delete
...
### SC Capacity and cost amplification
- category: cloud
...
### SC Delete-and-recreate of an environment without a plan artifact
...
### SC SSH port-forward that re-homes production onto localhost
- category: evasion
...
### SC Public exposure of cloud data stores
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
...
### SC IAM principals, keys and admin policies created from agent ancestry
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
- observable: exec-input
...
### SC Cluster RBAC self-escalation and token minting in Kubernetes
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
- observable: exec-input
...
### SC Audit trails and security telemetry switched off from agent ancestry
- category: cloud
- decision: approval_required | severity: 4
- pack: cloud | coverage: gap
- observable: exec-input
...
### SC Production off-switches: stop, restart, maintenance and scale-to-zero
- category: cloud
- decision: approval_required | severity: 3
- pack: cloud | coverage: gap
- observable: exec-input
...
### SC Destructive commands through warehouse and analytics CLIs
- category: database
- decision: approval_required | severity: 4
- pack: database | coverage: gap
- observable: exec-input
